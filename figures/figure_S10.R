...
# @Date:   2022-03-28
# @Description: Generate publication Figure s10 (Reversability of expression / splicing)
...
if (!dir.exists("figures/figure_s10/")){
  dir.create("figures/figure_10/")
}
...
pdf(file = "figures/figure_s10/ex_smoker_DEGS.pdf", w = 3.5, h = 8)
draw(ht_DEGs,
...
pdf(file = "figures/figure_s10/ex_smoker_DMP.pdf", w = 3.5, h = 2.6)
draw(ht_DMP,
     heatmap_legend_side = "right")
dev.off()
...
pdf("figures/figure_s10/Heatmaps.pdf",  height = 5.7 , w = 5)
...
pdf(file = "figures/figure_s10//logFC_methylation_subset.pdf", w = 4.5, h = 3.5)
g
dev.off()
...
pdf(file = "figures/figure_s10/logFC_expression_subset.pdf", w = 4.5, h = 3.5)
g
dev.off()
